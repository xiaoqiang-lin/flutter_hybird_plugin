...
import 'package:flutter_module_using_plugin/login/login_page.dart';
import 'package:flutter_module_using_plugin/mine/settings_screen.dart';
          ...
          Row(
            children: [
              Expanded(
                  child: AspectRatio(
                aspectRatio: 0.8,
                child: _item('assets/images/icon_fivestar.svg',
                    '给flutter_module_using_plugin\n5星好评', () {},
                    decoration: BoxDecoration(
                        boxShadow: AppTheme.appTheme.coloredBoxShadow(),
                        gradient: AppTheme.appTheme.containerGradient(
                          begin: Alignment.topRight,
